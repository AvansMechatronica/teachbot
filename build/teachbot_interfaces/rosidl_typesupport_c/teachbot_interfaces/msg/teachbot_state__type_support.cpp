...
static const _TeachbotState_type_support_symbol_names_t _TeachbotState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, teachbot_interfaces, msg, TeachbotState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, teachbot_interfaces, msg, TeachbotState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, teachbot_interfaces, msg, TeachbotState)() {
  return &::teachbot_interfaces::msg::rosidl_typesupport_c::TeachbotState_message_type_support_handle;
}
